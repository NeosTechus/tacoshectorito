...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'hero.description': 'Authentic Mexican cuisine on historic Cherokee Street. From sizzling tacos to homemade tortillas, experience the flavors of Mexico.',
    ...
    'menu.quesadillaHuasteca': 'Quesadilla Huasteca',
    ...
    'about.storyP1': 'El Torito began with a simple dream: to share the authentic flavors of Mexico with our St. Louis community. What started as a small family venture has grown into a beloved neighborhood destination on historic Cherokee Street.',
    ...
    'about.ctaTitle': 'Ready to Experience El Torito?',
    ...
    // Footer
    'footer.description': 'Authentic Mexican restaurant serving the St. Louis community since day one.',
  ...
  es: {
    ...
    'about.storyP1': 'El Torito comenzó con un sueño simple: compartir los sabores auténticos de México con nuestra comunidad de St. Louis. Lo que empezó como una pequeña empresa familiar se ha convertido en un destino querido en la histórica calle Cherokee.',
    ...
    'about.ctaTitle': '¿Listo para Experimentar El Torito?',
